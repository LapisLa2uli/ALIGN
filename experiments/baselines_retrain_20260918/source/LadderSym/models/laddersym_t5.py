...
from .ladder import laddersym_base_patch16_224
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def __init__(self, config: T5Config, use_prompt):
        ...
        self.encoder = laddersym_base_patch16_224(pretrained=False)
    ...
    def get_model_outputs(
        ...
        decoder_outputs = self.decoder(
            ...
            return_dict=return_dict,
            labels=labels,  
            initial_prompt_lengths = decoder_attention_mask.sum(dim=1).tolist() if self.use_prompt else 0,
        )
    ...
    def generate(
        ...
        **kwargs,
        ...
        for l in range(max_length):
            ...
            # Get the next token ids as [batch] (not [batch, 1]).
            next_tokens = torch.argmax(lm_logits[:, -1, :], dim=-1)

            # Keep finished sequences padded while decoding.
            next_tokens = (
