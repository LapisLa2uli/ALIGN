...
class InferenceHandler:
    ...
    def _split_token_into_length(
        ...
        for i in range(num_segment):
            ...
            score_paddings.append(start_padding + score_slice_len)
            if return_prompt_row is True:
