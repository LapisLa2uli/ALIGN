...
class InferenceHandler:
    ...
    def _split_token_into_length(
        ...
        for i in range(num_segment):
            ...
            score_slice_len = max(0, min(score_end_idx, score_frames.shape[0] - score_start_idx, 2 * max_length - start_padding))
