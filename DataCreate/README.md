...
Local pipeline for turning MusicXML/PDF scores plus performance recordings into labeled training-data bundles for music performance error detection. Methodology (schema 1.2 score-part gold, containment eval, synth error rules): [`../methodology.md`](../methodology.md). Volume synthetic data is generated by `synth-pipeline`, not Stage 9.
